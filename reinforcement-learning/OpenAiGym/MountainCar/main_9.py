...
class MountainCar(MountainCarBase):
    ...
    def train(self, childCnt=8):
        self.agent = Agent(self, memorySize=3000)
...
if __name__ == '__main__':
    root = getDataFilePath(f'MountainCar/MountainCar_9/')
    if not os.path.exists(root):
        os.mkdir(root)
    game = MountainCar('MountainCar-v0', os.path.join(root, f'MountainCar_9_1'))
    game.train()
    # game.display()
